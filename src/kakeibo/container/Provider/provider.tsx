...
type KakeiboProviderValue = {
  ...
  kakeiboDispatch: React.Dispatch<PayloadAction<number | Array<number> | boolean>>;
};
...
const KakeiboProvider: React.FC<KakeiboProviderProps> = (
  props: KakeiboProviderProps
) => {
  const [kakeiboInfo, kakeiboDispatch] = useReducer(
    kakeiboSlice.reducer,
    initialState
  );
