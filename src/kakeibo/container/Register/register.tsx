...
const Register:React.FC = () => {
    ...
    const registerClick = useCallback(() => {
        db.collection("Kakeibo").doc("202105").set({
        detail:{
    ...
    },[kakeiboInfo.detailPlan,kakeiboInfo.resultPlan,kakeiboInfo.lastResultPlan,kakeiboInfo.mainIncome,kakeiboInfo.subIncome])
    return<><CompRegister registerClick={registerClick} /></>
}
